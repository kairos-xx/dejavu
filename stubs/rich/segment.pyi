...
from typing import Iterable, List, NamedTuple, Optional, Sequence, TYPE_CHECKING, Tuple, Type, Union
...
class Segment(NamedTuple):
    ...
    @classmethod
    def align_top(cls: Type[Segment], lines: List[List[Segment]], width: int, height: int, style: Style, new_lines: bool = ...) -> List[List[Segment]]:
    ...
    @classmethod
    def align_bottom(cls: Type[Segment], lines: List[List[Segment]], width: int, height: int, style: Style, new_lines: bool = ...) -> List[List[Segment]]:
    ...
    @classmethod
    def align_middle(cls: Type[Segment], lines: List[List[Segment]], width: int, height: int, style: Style, new_lines: bool = ...) -> List[List[Segment]]:
