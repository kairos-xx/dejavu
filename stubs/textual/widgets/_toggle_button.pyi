...
class ToggleButton(Static, can_focus=True):
    ...
    def __init__(self, label: ContentText = ..., value: bool = ..., button_first: bool = ..., *, name: str | None = ..., id: str | None = ..., classes: str | None = ..., disabled: bool = ..., tooltip: RenderableType | None = ..., compact: bool = ...) -> None:
